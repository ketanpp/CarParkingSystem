...
Summary of Problem:
This System AllocateParking Lot to User 
It also Generate the total fair when any vehicle vacant the parking

How to Use this System:

nstall all dependencies (testing dependent packages) "npm install"

Run the main program "node index.js ./Inputs.txt"

Run all tests cases "npm test .\Tests\Test.js"
